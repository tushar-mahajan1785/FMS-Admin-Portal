...
export const API_ADD_DOCUMENTS_GROUP = `${BASE}/document-group/add-or-edit`

export const API_DELETE_DOCUMENTS_GROUP = `${BASE}/document-group/remove`

export const API_DOCUMENTS_GROUP_DETAILS = `${BASE}/document-group/details`

// inventory
export const API_INVENTORY_LIST = `${BASE}/inventory/list`

export const API_INVENTORY_ADD = `${BASE}/inventory/add-or-edit`
...
export const API_GET_INVENTORY_TRANSACTION_HISTORY = `${BASE}/inventory/stock-list`

export const API_INVENTORY_RESTOCK_SAVE = `${BASE}/inventory/restock`

export const API_INVENTORY_CONSUMPTION_SAVE = `${BASE}/inventory/usage`
...
export const API_TECHNICIAN_EMPLOYEE_PROFILE_UPLOAD = `${BASE_APP}/employee/profile-image-upload`

export const API_TECHNICIAN_EMPLOYEE_PROFILE_UPLOAD_REMOVE = `${BASE_APP}/employee/profile-image-remove`
