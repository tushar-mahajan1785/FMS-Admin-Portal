    ...
    return (
        ...
        >
            ...
            <DialogContent sx={{
                ...
                <Stack sx={{ borderRadius: '8px', border: `1px solid ${theme.palette.grey[300]}` }}>
                    <Stack sx={{ flexDirection: 'row', columnGap: 2, paddingY: '24px', paddingX: '20px' }}>
                        {
                            statusOptions && statusOptions !== null && statusOptions.length > 0 ?
                                statusOptions.map((objStatus) => {
                                    return (<Stack
                                        ...
                                        onClick={() => {
                                            console.log('-------objStatus?.label-------', objStatus?.label)
                            ...
                            <Grid container spacing={'24px'}>
                                <Grid size={{ xs: 12, sm: 6, md: 6, lg: 6, xl: 6 }}>
                                    <Controller
                                        ...
                                        control={control}
                                        rules={{
                                            required: `${getFieldTitleObject(selectedStatus)?.title} Title is required`,
                                            maxLength: {
                                                value: 255,
                                        ...
                                        render={({ field }) => (
                                            <CustomTextField
                                                fullWidth
                                                placeholder={`Enter ${getFieldTitleObject(selectedStatus)?.placeholder} title`}
                                                value={field?.value}
                                                label={<FormLabel label={`${getFieldTitleObject(selectedStatus)?.title} Title`} required={true} />}
                                ...
                                <Grid size={{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12 }}>
                                    <Controller
                                        ...
                                        control={control}
                                        rules={{
                                            required: `${getFieldTitleObject(selectedStatus)?.title} Description is required`,
                                            maxLength: {
                                                value: 255,
                                                message: 'Maximum length is 255 characters'
                                            },
                                        ...
                                        render={({ field }) => (
                                            <CustomTextField
                                                ...
                                                value={field?.value}
                                                label={<FormLabel label={`${getFieldTitleObject(selectedStatus)?.title} Description`} required={true} />}
                                                onChange={field.onChange}
