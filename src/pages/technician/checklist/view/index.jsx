    ...
    */
    ...
    return (
        ...
        >
            ...
            <Stack sx={{ rowGap: 1, marginBottom: 8, border: selectedAssetStatus === 'Approved' ? `1px solid ${theme.palette.success[600]}` : `1px solid ${theme.palette.grey[100]}`, borderRadius: '16px' }}>
